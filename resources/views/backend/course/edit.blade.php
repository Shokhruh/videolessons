                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input type="text" name="name" class="form-control" id="11" value="{{ $course->name }}">
                                            </div>

                                            <div style="margin-bottom: 20px;">
                                                <input type="hidden" name="user_id" class="form-control" id="11" value="{{ $course->user_id }}">
                                            </div>

                                            <div style="margin-bottom: 20px;">
                                                <label style="margin-bottom: 10px;" for="12" class="form-label">Kimlar uchun?</label>
                                                <input type="text" name="for_whom" class="form-control" id="12" value="{{ $course->for_whom }}">
                                            </div>

                                            <div style="margin-bottom: 20px;">
                                                <label style="margin-bottom: 10px;" for="desc" class="form-label">Description</label>
                                                <textarea class="form-control" id="desc" name="description">{{ $course->description }}</textarea>
                                            </div>

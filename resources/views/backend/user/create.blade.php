                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input type="text" name="username" class="form-control" id="11">
                                            </div>
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input type="email" name="email" class="form-control" id="12">
                                            </div>

                                            <div style="margin-bottom: 20px;">
                                                <label style="margin-bottom: 10px;" for="where_uz" class="form-label">Password</label>
                                                <input type="password" name="password" class="form-control" id="where_uz">
                                            </div>

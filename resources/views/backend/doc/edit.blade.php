            ...
            <div class="card" style="margin-top: 30px;">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between" style="margin-bottom: 20px;">
                        <h4>Hujjatni tahrirlash</h4>
                        <a href="{{ route('docs.index') }}" class="btn btn-warning"></i>Ortga qaytish</a>
                    </div>
                    <form action="{{ route('docs.update', ['doc' => $doc->id]) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        @if ($errors->any())
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div style="margin-bottom: 20px;">
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <input type="text" name="name" class="form-control" id="11" value="{{ $doc->name }}">
                                            </div>

                                            <div style="margin-bottom: 20px;">
                                                <input type="hidden" name="user_id" class="form-control" id="11" value="{{ $doc->user_id }}">
                                            </div>
